        ...
        <div class="login-box mb-5 p-3 pt-5">
            ...
            <form class="d-flex justify-content-center flex-column align-items-center" role="form" action="login.php" method="post">
                ...
                if (isset($_GET['success'])) {
                    echo '<div class="alert alert-success" role="success">Succesfully registered</div>';
                }
                ?>
            ...
            <div class="d-flex justify-content-center flex-column align-items-center"><button class="m-3" type="submit" name="login" onclick="location.href='register.php';">Register</button></div>
        </div>
        <div class="p-5"></div>
        <div class="p-5"></div>
        <div class="p-5"></div>
